...
import { submitInquiry, fetchServices } from "../api/api";
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <select
                ...
                className="w-full bg-black border border-white/20 rounded-lg px-4 py-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <option value="">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-105 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
